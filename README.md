...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-meadow-3591
```

A live public deployment of this template is available at [https://twilight-meadow-3591.templates.workers.dev](https://twilight-meadow-3591.templates.workers.dev)
